...
public class ServiceRequestPageController {
  ...
  public void initialize() {
    ...
    //    logoutPopup(false);
    //
    //    // When the menu button is clicked, invert the value of menuVisibility and set the menu
    // bar to
    //    // that value
  ...
  //        event -> {
  //          btn.setStyle(
  //              "-fx-background-color: #ffffff; -fx-alignment: center; -fx-border-color: #192d5a;
  // -fx-border-width: 2;");
  ...
  //        requests.stream()
  //            .filter(request ->
  // request.getRequestStatus().equals(ServiceRequestData.Status.PENDING))
  //            .toList();
  //
