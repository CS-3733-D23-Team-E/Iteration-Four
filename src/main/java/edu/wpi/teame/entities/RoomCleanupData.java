...
public class RoomCleanupData extends ServiceRequestData{
    ...
    @Getter @Setter
    private String restockSupplies;
    public RoomCleanupData(int requestID, String room, String deliverDate,
                           String deliveryTime, String assignedStaff, String severityLevel,
                           String cleaningSupplies, String restockSupplies, Status status) {
